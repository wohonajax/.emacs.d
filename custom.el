...
(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes zenburn-theme sly-macrostep amx ido-completing-read+ helm slime offlineimap paredit sly wanderlust rainbow-delimiters dropbox flycheck ein py-autopep8 elpy))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 98 :width normal :foundry "unknown" :family "Dina"))))
 ...
 '(show-paren-match ((t (:background "#fa5750"))))
